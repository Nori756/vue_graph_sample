...
export default {
  extends: Bar,
  mounted() {
     this.axios.get('http://127.0.0.1:8000/hey/')
              .then(response => 
    ...
    this.renderChart(
      {
          labels: ["2022/2/1", "2022/2/2", "2022/2/3", "2022/2/4.", "2022/2/5", "2022/2/6", "2022/2/7", "2022/2/8", "2022/2/9", "2022/2/10", "2022/2/11", "2022/2/12"],
          datasets: [{
              label: "ワード1",
              borderWidth:1,
